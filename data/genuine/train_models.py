...
def train(model_type: Model, dimension: int):
    ...
    training_corpus = MmCorpus(bow_corpus_file) if model_type in [Model.LSI, Model.LDA] else LineCorpus(low_corpus_file)
...
if __name__ == "__main__":
    """
    Train LSI, LDA and doc2vec models for selected dimensions.
    """
    parser = argparse.ArgumentParser(description='Train LSI, LDA and doc2vec models.')
